...
#### Option 1. Enabling Authentication via MCP Tools

Use the `mcp_firebase-mcp-server_firebase_init` tool to enable Authentication. Only Google Sign In, anonymous auth, and email/password auth can be enabled via this tool.
